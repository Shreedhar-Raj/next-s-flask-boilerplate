            ...
            <div className="relative border-r w-full bg-cover lg:w-6/12 xl:w-7/12 bg-gradient-to-r from-white via-white to-gray-100">
              <div className="relative flex flex-col items-center justify-center w-full h-full px-10 my-20 lg:px-16 lg:my-0">
                <div className="flex flex-col items-start space-y-8 tracking-tight lg:max-w-3xl">
                  ...
                  <a href="#_" className="inline-block px-8 py-5 text-xl font-medium text-center text-white transition duration-200 bg-orange-400 rounded-lg hover:bg-orange-500 ease" data-primary="blue-600" data-rounded="rounded-lg">Get Started Today</a>
                </div>
              </div>
            </div>
            ...
            <div className="w-full bg-white lg:w-6/12 xl:w-5/12">
              <div className="flex flex-col items-start justify-start w-full h-full p-10 lg:p-16 xl:p-24">
                ...
                <div className="relative w-full mt-10 space-y-8">
                  ...
                  <div className="relative">
                    <button onClick={(e) => {handleSubmit()}} className="inline-block w-full px-5 py-4 text-lg font-medium text-center text-white transition duration-200 bg-orange-400 rounded-lg hover:bg-orange-500 ease" data-primary="blue-600" data-rounded="rounded-lg">Create Account</button>
